...
typedef enum {
	PIGEON_MSG_PAIR_HELLO = 0,
	PIGEON_MSG_PAIR_HELLO_ACK,
	PIGEON_MSG_PAIR_CONFIRM,
	PIGEON_MSG_PAIR_COMPLETE,
	PIGEON_MSG_AUTH_REQUEST,
	PIGEON_MSG_AUTH_OK,
	PIGEON_MSG_LAN_OFFER,
	PIGEON_MSG_LAN_VERIFY,
	PIGEON_MSG_LAN_CONFIRM,
	PIGEON_MSG_PATH_PING,
	PIGEON_MSG_PATH_PONG,
	PIGEON_MSG_COUNT
} session_msg_type;
...
typedef enum {
	...
	PIGEON_GUARD_CHALLENGE_VALID,
	PIGEON_GUARD_CHALLENGE_INVALID,
	PIGEON_GUARD_LAN_ENABLED,
	PIGEON_GUARD_LAN_DISABLED,
	PIGEON_GUARD_LAN_SERVER_AVAILABLE,
	PIGEON_GUARD_UNDER_MAX_FAILURES,
	PIGEON_GUARD_AT_MAX_FAILURES,
	PIGEON_GUARD_COUNT
} session_guard_id;
...
typedef enum {
	...
	PIGEON_ACTION_ACTIVATE_LAN,
	PIGEON_ACTION_FALLBACK_TO_RELAY,
	PIGEON_ACTION_RESET_FAILURES,
	PIGEON_ACTION_SEND_PAIR_HELLO,
	PIGEON_ACTION_STORE_SECRET,
	PIGEON_ACTION_DIAL_LAN,
	PIGEON_ACTION_BRIDGE_STREAMS,
	PIGEON_ACTION_UNBRIDGE,
	PIGEON_ACTION_COUNT
} session_action_id;

// Session events.
typedef enum {
	PIGEON_EVENT_APP_SEND = 0,
	PIGEON_EVENT_APP_RECV,
	PIGEON_EVENT_APP_SEND_DATAGRAM,
	PIGEON_EVENT_APP_RECV_DATAGRAM,
	PIGEON_EVENT_APP_CLOSE,
	PIGEON_EVENT_APP_FORCE_FALLBACK,
	PIGEON_EVENT_RELAY_STREAM_DATA,
	PIGEON_EVENT_RELAY_STREAM_ERROR,
	PIGEON_EVENT_RELAY_DATAGRAM,
	PIGEON_EVENT_LAN_STREAM_DATA,
	PIGEON_EVENT_LAN_STREAM_ERROR,
	PIGEON_EVENT_LAN_DATAGRAM,
	PIGEON_EVENT_LAN_DIAL_OK,
	PIGEON_EVENT_LAN_DIAL_FAILED,
	PIGEON_EVENT_LAN_VERIFY_OK,
	PIGEON_EVENT_PING_TIMEOUT,
	PIGEON_EVENT_PING_TICK,
	PIGEON_EVENT_BACKOFF_EXPIRED,
	PIGEON_EVENT_OFFER_TIMEOUT,
	PIGEON_EVENT_CLI_INIT_PAIR,
	PIGEON_EVENT_TOKEN_CREATED,
	PIGEON_EVENT_RELAY_REGISTERED,
	PIGEON_EVENT_ECDH_COMPLETE,
	PIGEON_EVENT_SIGNAL_CODE_DISPLAY,
	PIGEON_EVENT_CLI_CODE_ENTERED,
	PIGEON_EVENT_CHECK_CODE,
	PIGEON_EVENT_FINALISE,
	PIGEON_EVENT_VERIFY,
	PIGEON_EVENT_SESSION_ESTABLISHED,
	PIGEON_EVENT_LAN_SERVER_READY,
	PIGEON_EVENT_LAN_SERVER_CHANGED,
	PIGEON_EVENT_READVERTISE_TICK,
	PIGEON_EVENT_DISCONNECT,
	PIGEON_EVENT_BACKCHANNEL_RECEIVED,
	PIGEON_EVENT_SECRET_PARSED,
	PIGEON_EVENT_RELAY_CONNECTED,
	PIGEON_EVENT_KEY_PAIR_GENERATED,
	PIGEON_EVENT_CODE_DISPLAYED,
	PIGEON_EVENT_APP_LAUNCH,
	PIGEON_EVENT_VERIFY_TIMEOUT,
	PIGEON_EVENT_LAN_ERROR,
	PIGEON_EVENT_RELAY_OK,
	PIGEON_EVENT_BACKEND_REGISTER,
	PIGEON_EVENT_CLIENT_CONNECT,
	PIGEON_EVENT_CLIENT_DISCONNECT,
	PIGEON_EVENT_BACKEND_DISCONNECT,
	PIGEON_EVENT_RECV_PAIR_HELLO,
	PIGEON_EVENT_RECV_AUTH_REQUEST,
	PIGEON_EVENT_RECV_LAN_VERIFY,
	PIGEON_EVENT_RECV_PATH_PONG,
	PIGEON_EVENT_RECV_PAIR_HELLO_ACK,
	PIGEON_EVENT_RECV_PAIR_CONFIRM,
	PIGEON_EVENT_RECV_PAIR_COMPLETE,
	PIGEON_EVENT_RECV_AUTH_OK,
	PIGEON_EVENT_RECV_LAN_OFFER,
	PIGEON_EVENT_RECV_LAN_CONFIRM,
	PIGEON_EVENT_RECV_PATH_PING,
	PIGEON_EVENT_COUNT
} session_event_id;

// Session commands.
typedef enum {
	PIGEON_CMD_WRITE_ACTIVE_STREAM = 0,
	PIGEON_CMD_SEND_ACTIVE_DATAGRAM,
	PIGEON_CMD_SEND_PATH_PING,
	PIGEON_CMD_SEND_PATH_PONG,
	PIGEON_CMD_SEND_LAN_OFFER,
	PIGEON_CMD_SEND_LAN_VERIFY,
	PIGEON_CMD_SEND_LAN_CONFIRM,
	PIGEON_CMD_DIAL_LAN,
	PIGEON_CMD_DELIVER_RECV,
	PIGEON_CMD_DELIVER_RECV_ERROR,
	PIGEON_CMD_DELIVER_RECV_DATAGRAM,
	PIGEON_CMD_START_LAN_STREAM_READER,
	PIGEON_CMD_STOP_LAN_STREAM_READER,
	PIGEON_CMD_START_LAN_DG_READER,
	PIGEON_CMD_STOP_LAN_DG_READER,
	PIGEON_CMD_START_MONITOR,
	PIGEON_CMD_STOP_MONITOR,
	PIGEON_CMD_START_PONG_TIMEOUT,
	PIGEON_CMD_CANCEL_PONG_TIMEOUT,
	PIGEON_CMD_START_BACKOFF_TIMER,
	PIGEON_CMD_CLOSE_LAN_PATH,
	PIGEON_CMD_SIGNAL_LAN_READY,
	PIGEON_CMD_RESET_LAN_READY,
	PIGEON_CMD_SET_CRYPTO_DATAGRAM,
	PIGEON_CMD_COUNT
} session_cmd_id;
