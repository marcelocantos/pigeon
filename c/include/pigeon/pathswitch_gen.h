...
typedef enum {
	...
	PIGEON_ACTION_REBRIDGE_STREAMS,
	PIGEON_ACTION_COUNT
} path_switch_action_id;

// PathSwitch events.
typedef enum {
	PIGEON_EVENT_LAN_SERVER_READY = 0,
	...
	PIGEON_EVENT_RECV_RELAY_RESUME,
	PIGEON_EVENT_COUNT
