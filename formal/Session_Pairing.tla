...
vars == <<backend_state, client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
backend_WaitingForClient_to_DeriveSecret_on_pair_hello_token_valid ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, received_backend_pub, client_shared_key, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
backend_DeriveSecret_to_SendAck_ecdh_complete ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
backend_SendAck_to_WaitingForCode_signal_code_display ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_complete, received_auth_ok>>
...
backend_WaitingForCode_to_ValidateCode_cli_code_entered ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
backend_ValidateCode_to_Idle_check_code_code_wrong ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
backend_StorePaired_to_Paired_finalise ==
    ...
    /\ UNCHANGED <<client_state, current_token, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_auth_ok>>
...
backend_Paired_to_AuthCheck_on_auth_request ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, auth_nonces_used, qr_displayed, received_pair_hello, received_pair_hello_ack, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
backend_AuthCheck_to_SessionActive_verify_device_known ==
    ...
    /\ UNCHANGED <<client_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_pair_complete>>
...
client_E2EReady_to_ShowCode_on_pair_confirm ==
    ...
    /\ UNCHANGED <<backend_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_complete, received_auth_ok>>
...
client_WaitPairComplete_to_Paired_on_pair_complete ==
    ...
    /\ UNCHANGED <<backend_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_auth_ok>>
...
client_Reconnect_to_SendAuth_relay_connected ==
    ...
    /\ UNCHANGED <<backend_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_pair_hello_ack, received_pair_confirm, received_pair_complete, received_auth_ok>>
...
client_SendAuth_to_SessionActive_on_auth_ok ==
    ...
    /\ UNCHANGED <<backend_state, current_token, active_tokens, used_tokens, backend_ecdh_pub, received_client_pub, received_backend_pub, backend_shared_key, client_shared_key, backend_code, client_code, received_code, code_attempts, device_secret, paired_devices, received_device_id, auth_nonces_used, received_auth_nonce, qr_displayed, received_pair_hello, received_auth_request, received_pair_hello_ack, received_pair_confirm, received_pair_complete>>
